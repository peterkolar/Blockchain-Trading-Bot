...
let exchangeFactoryContract
let EXCHANGE_PAIR_ABI
if (chain == eth)
{
  exchangeFactoryContract = uniswapV2FactoryContract;
  EXCHANGE_PAIR_ABI = UNISWAP_V2_FACTORY_ABI;
}
if (chain == bsc)
{
  exchangeFactoryContract = pancakeV2FactoryContract;
  EXCHANGE_PAIR_ABI = PANCAKESWAP_V2_PAIR_ABI
}
if (chain == polygon)
{
  exchangeFactoryContract = quickswapFactoryContract;
